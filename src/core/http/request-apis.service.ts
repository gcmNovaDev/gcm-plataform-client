...
class ApiService {
  ...
  async post<T>(url: string, data: any, authType: AuthType, config?: AxiosRequestConfig): Promise<T> {
  ...
  async put<T>(url: string, data: any, authType: AuthType, config?: AxiosRequestConfig): Promise<T> {
  ...
  async patch<T>(url: string, data: any, authType: AuthType, config?: AxiosRequestConfig): Promise<T> {
