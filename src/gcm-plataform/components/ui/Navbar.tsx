...
import { ChevronDown, LogOut, Key, ArrowLeft, User } from "lucide-react";
...
const Navbar: React.FC<NavbarProps> = ({ showBack = false, onBack }) => {
  ...
  const handleLogout = () => {
    logout();
    router.push("/plataform-process/Auth");
  };
          ...
          <>
            ...
            <div className="absolute right-0 mt-2 w-56 bg-white shadow-lg rounded-md border border-app-gray-1-300 py-1 z-20 origin-top-right">
              ...
              <div className="px-4 py-2 bg-slate-50 border-b border-app-gray-1-200 mb-1">
                <p className="text-[10px] font-bold text-app-gray-1-400 uppercase tracking-widest">Sesión Activa</p>
